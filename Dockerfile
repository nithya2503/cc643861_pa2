...
COPY wine_qual_test_pred.py /code/src

COPY testdata.model/ /code/data/model/testdata.model
...
ENTRYPOINT ["/opt/spark/bin/spark-submit",  "src/wine_qual_test_pred.py"]